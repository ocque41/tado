...
| 2.16 | Blinking cursor on Metal path (~530 ms Terminal.app cadence). Activity resets the phase so the cursor doesn't disappear during typing. Toggle in Settings → Rendering → "Blink cursor". | ✅ shipped (46/46 tests green) |
