...
struct ProjectsView: View {
    ...
    /// Which team row is currently expanded in the project-detail view.
    /// One-at-a-time accordion — tapping a different team swaps, tapping
    /// the open one collapses. Nil means no team is expanded.
